...
public class WoodSprite extends Sprite{
	...
	public final static Image SPRITE_IMAGE = new Image("assets/mainCharacters/WoodSprite_Idle.gif",WoodSprite.SPRITE_WIDTH*0.70,WoodSprite.SPRITE_WIDTH,false,false);
