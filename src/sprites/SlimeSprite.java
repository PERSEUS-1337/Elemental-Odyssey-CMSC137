...
public class SlimeSprite extends Sprite{
	...
	public final static Image SPRITE_IMAGE = new Image("assets/players/SlimeSprite_Idle.gif",SlimeSprite.SPRITE_WIDTH*0.70,SlimeSprite.SPRITE_WIDTH,false,false);
